...
> `PagoVenta`, arqueo/reportes por medio, UI de cobro) y **4.B** (devolución parcial: reintegra
> stock + descuenta el efectivo del arqueo, solo admin). **Pendiente / a decidir:** 1.B
...
> cifrado de secretos). **4.A (DTE) fuera de alcance.**
